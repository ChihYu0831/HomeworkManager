...
namespace HomeworkManager.Forms.Pages
{
    public class HomeworkPage : Panel
    {
        ...
        private void Build()
        {
            ...
            tbl.RowStyles.Add(new RowStyle(SizeType.Absolute, 358)); // 輸入+搜尋
            ...
            grpSearch.Controls.Add(MakeBtnAt("顯示全部", Color.FromArgb(108, 117, 125), new Point(498, 26), (s, e) => { txtSearch.Clear(); RefreshGrid(_service.GetAll()); }));
